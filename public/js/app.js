...
},{"./helpers/bind":15,"is-buffer":34}],26:[function(require,module,exports){
...
},{"global/document":30,"hyperx":33,"on-load":40}],27:[function(require,module,exports){
...
},{"assert":39,"global/document":30,"global/window":31}],41:[function(require,module,exports){
(function (process){
...
},{"_process":43,"path-to-regexp":42}],42:[function(require,module,exports){
...
},{"isarray":35}],43:[function(require,module,exports){
...
},{"./agent-base":44,"./is-object":46,"./request-base":47,"./response-base":48,"component-emitter":28}],46:[function(require,module,exports){
'use strict';
...
},{"./update-events.js":53,"bel":26,"morphdom":38}],53:[function(require,module,exports){
module.exports = [
...
},{"empty-element":29,"yo-yo":52}],55:[function(require,module,exports){
...
function loadPictures(ctx, next) {
    request.get('/api/pictures').end((err, res) => {
...
function loadPicturesFetch(ctx, next) {
    fetch.get('/api/pictures').then(res => {
        //we can nest axios and we an use all the then 
        ctx.pictures = res.data;
        next();
    }).catch(err => {
...
module.exports = function (pictures) {
    ...
    function onsubmit(ev) {
        ...
        request.post('/api/pictures').send(data).end((err, res) => {
...
},{"../layout":59,"../picture-card":60,"superagent":45,"yo-yo":52}],57:[function(require,module,exports){
var page = require('page');
...
},{"./homepage":55,"./signin":61,"./signup":63,"./user-page":65,"moment":37,"moment/locale/es":36,"page":41}],58:[function(require,module,exports){
var yo = require('yo-yo');
...
},{"yo-yo":52}],59:[function(require,module,exports){
var yo = require('yo-yo');
...
},{"yo-yo":52}],60:[function(require,module,exports){
var yo = require('yo-yo');
var moment = require('moment');
...
},{"moment":37,"yo-yo":52}],61:[function(require,module,exports){
var page = require('page');
var empty = require('empty-element');
var template = require('./template');
var main = document.getElementById('main-container');
...
},{"./template":62,"empty-element":29,"page":41,"title":50}],62:[function(require,module,exports){
var yo = require('yo-yo');
...
},{"../landing":58,"yo-yo":52}],63:[function(require,module,exports){
var page = require('page');
var empty = require('empty-element');
var template = require('./template');
var main = document.getElementById('main-container');
...
},{"./template":64,"empty-element":29,"page":41,"title":50}],64:[function(require,module,exports){
var yo = require('yo-yo');
var landing = require('../landing');
...
},{"../landing":58,"yo-yo":52}],65:[function(require,module,exports){
var page = require('page');
var header = require('../header');
var title = require('title');
var empty = require('empty-element');
...
},{"../header":54,"./template":66,"empty-element":29,"page":41,"title":50}],66:[function(require,module,exports){
var yo = require('yo-yo');
var layout = require('../layout');
